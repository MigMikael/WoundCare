...
def analyze_wound_size():
    # This function should call man's model for
    # It should receive wound size in pixel
    wound_size = 44
    return wound_size
...
real_wound_size = analyze_wound_size() * avg_pixelPerInch
print(real_wound_size)
cv2.imwrite('/var/www/html/WoundCare/public/contour_ref.jpg', orig)
#print("Finish")
